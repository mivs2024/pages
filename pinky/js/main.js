...
var $navbarToggle = document.querySelector('.burger');
...
var $menuToggles = document.querySelectorAll('.menu__link--mobile.menu__link--toggle');
if ($menuToggles) {
  $menuToggles.forEach(function (m) {
    m.onclick = function () {
...
if (window.location.pathname.includes('index') || window.location.pathname === '/') {
  var mainSlider = document.querySelector('.main-slider__swiper');
  var $mainPetsSlider = document.querySelector('.main-pets__swiper .swiper-wrapper');
  var $mainZones = document.querySelector('.main-zones__list');
  var $mainExperts = document.querySelector('.main-experts__list');

  // init Swiper:
  if (mainSlider) {
    new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](mainSlider, {
      slidesPerView: 1,
      loop: "true",
  ...
  var setMainZones = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            _context.n = 1;
            return fetch('./resources/zones.json');
          case 1:
            res = _context.v;
            _context.n = 2;
            return res.json();
          case 2:
            ...
            data.forEach(function (p) {
              item = "\n                   <div class=\"card-zone\" data-id=".concat(p.id, ">\n            <a href=").concat(p.link, " class=\"card-zone__link\">\n                <div class=\"card-zone__image\">\n                    <img src=\"/images/zones/").concat(p.images[0], "\" alt=\"\">\n                </div>\n                <p class=\"card-zone__text text-big\">\n                    ").concat(p.name, "\n                </p>\n            </a>\n    \n        </div>\n                    ");
              $mainZones.insertAdjacentHTML('afterbegin', item);
            });
          case 3:
            return _context.a(2);
        }
    ...
    return function setMainZones() {
      return _ref.apply(this, arguments);
    };
  }();
  var setMainPetsSlider = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      var res, data, item, mainPetsSlider;
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            _context2.n = 1;
            return fetch('./resources/pets.json');
          case 1:
            res = _context2.v;
            _context2.n = 2;
            return res.json();
          case 2:
            ...
            item = '';
            data.forEach(function (p) {
              item = "\n                   <div class=\"swiper-slide main-events__slide\">\n                            <div class=\"card-pet\" data-id=".concat(p.id, ">\n                                <a class=\"card-pet__link\" href=").concat(p.link, ">\n                                    <img src=\"/images/pets/").concat(p.images[0], "\" alt=\"\">\n                                </a>\n                                <div class=\"card-pet__name\">\n                                    <a class=\"card-pet__link2\"href=").concat(p.link, ">\n                                        <h3 class=\"subtitle left\">").concat(p.name, "</h3>\n                                    </a>\n                                </div>\n                               \n                            </div>\n                        </div>\n                    ");
              $mainPetsSlider.insertAdjacentHTML('beforeend', item);
            });
            mainPetsSlider = document.querySelector('.main-pets__swiper');
            if (mainPetsSlider) {
              new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](mainPetsSlider, {
                spaceBetween: 20,
                slidesPerView: "auto",
                loop: true,
                // configure Swiper to use modules
    ...
    return function setMainPetsSlider() {
      return _ref2.apply(this, arguments);
    };
  }();
  var setMainExperts = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
      var res, data, item, lightbox;
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.n) {
          case 0:
            _context3.n = 1;
            return fetch('./resources/workers.json');
          case 1:
            res = _context3.v;
            _context3.n = 2;
            return res.json();
          case 2:
            ...
            item = '';
            data.forEach(function (p) {
              item = "\n                   <div class=\"card-expert\" data-id=".concat(p.id, ">\n            <a href=\"/\" class=\"card-expert__link\"\n                data-pswp-src=\"/images/workers/").concat(p.images[0], "\"\n                data-pswp-width=\"1500\" \n    data-pswp-height=\"1000\" \n            >\n            <div class=\"card-expert__image\">\n                <div class=\"card-expert__zoom\" >\n                   <svg class=\"svg-icon\" style=\"width: 50px;vertical-align: middle;fill: currentColor;overflow: hidden;\" viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M428.447049 130.400932c-165.798117 0-300.69648 134.931109-300.69648 300.759925 0 165.798117 134.899386 300.69648 300.69648 300.69648 165.829839 0 300.728202-134.899386 300.728202-300.69648C729.175251 265.332041 594.274842 130.400932 428.447049 130.400932zM428.447049 672.01439c-132.821051 0-240.821811-108.032482-240.821811-240.853533 0-132.821051 108.032482-240.885256 240.821811-240.885256s240.853533 108.064204 240.853533 240.885256C669.331281 563.981908 561.267077 672.01439 428.447049 672.01439z\" fill=\"white\" /><path d=\"M872.861768 774.315334 763.127528 664.581094c-27.182083-27.182083-71.276347-27.182083-98.458429 0-27.182083 27.182083-27.182083 71.276347 0 98.458429l109.702518 109.733217c27.182083 27.212782 71.276347 27.212782 98.490152 0C900.011104 845.591681 900.011104 801.496393 872.861768 774.315334z\" fill=\"white\" /></svg>\n                </div>\n\n                <img src=\"/images/workers/").concat(p.images[0], "\" alt=\"\">\n                </div>\n                <h3 class=\"card-expert__name text-big center\">\n                    ").concat(p.name, "\n                </h3>\n                <p class=\"card-expert__position text center\">\n                    ").concat(p.position, "\n                </p>\n            </a>\n    \n        </div>\n                    ");
              $mainExperts.insertAdjacentHTML('beforeend', item);
            });
            lightbox = new photoswipe_lightbox__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    return function setMainExperts() {
...
var zonesSlider = document.querySelector('.zones-slider__swiper');
var $zonesSlider = document.querySelector('.zones-slider__swiper .swiper-wrapper');
var setZone = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
    var res, data, item;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 2:
          ...
          data.filter(function (d) {
            return d.link === window.location.pathname;
          })[0].images.forEach(function (p) {
            item = "\n                    <div class=\"swiper-slide zones-slider__slide\">\n                    <img src=\"/images/zones/".concat(p, "\" alt=\"image\">\n                </div>\n                    ");
            $zonesSlider.insertAdjacentHTML('afterbegin', item);
          });

          // init Swiper:
          if (zonesSlider) {
            new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](zonesSlider, {
              slidesPerView: 1,
              loop: "true",
              // configure Swiper to use modules
...
/* harmony import */ var _css_loader_dist_cjs_js_photoswipe_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../css-loader/dist/cjs.js!./photoswipe.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/photoswipe/dist/photoswipe.css");
...
/* harmony import */ var _components_zones_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/zones.js */ "./src/js/components/zones.js");
